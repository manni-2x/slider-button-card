...
function t(t, e, i, s) {
    ...
    if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) n = Reflect.decorate(t, e, i, s);
        ...
        for (var a = t.length - 1; a >= 0; a--)(r = t[a]) && (n = (o < 3 ? r(n) : o > 3 ? r(e, i, n) : r(e, i)) || n);
...
function r(t, e) {
    for (var i = [], s = 0, r = t.length; s < r; s++) i.push(t[s].substr(0, e));
    return i
}
var o = function(t) {
    return function(e, i) {
        var s = i[t].map((function(t) {
...
var a = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"],
    ...
    p = {
        ...
        ZZ: function(t) {
            ...
            return (e > 0 ? "-" : "+") + u(100 * Math.floor(Math.abs(e) / 60) + Math.abs(e) % 60, 4)
        },
        Z: function(t) {
            var e = t.getTimezoneOffset();
            return (e > 0 ? "-" : "+") + u(Math.floor(Math.abs(e) / 60), 2) + ":" + u(Math.abs(e) % 60, 2)
        }
    },
    g = function(t) {
        return +t - 1
    ...
    f = [null, "[1-9]\\d?"],
    b = [null, i],
    m = ["isPm", i, function(t, e) {
        var i = t.toLowerCase();
        return i === e.amPm[0] ? 0 : i === e.amPm[1] ? 1 : null
    }],
    _ = ["timezoneOffset", "[^\\s]*?[\\+\\-]\\d\\d:?\\d\\d|[^\\s]*?Z?", function(t) {
    ...
    v = (o("monthNamesShort"), o("monthNames"), {
...
var y = function(t, i, r) {
    if (void 0 === i && (i = v.default), void 0 === r && (r = {}), "number" == typeof t && (t = new Date(t)), "[object Date]" !== Object.prototype.toString.call(t) || isNaN(t.getTime())) throw new Error("Invalid Date pass to format");
    var o = [];
    i = (i = v[i] || i).replace(s, (function(t, e) {
        return o.push(e), "@@@"
    }));
    var a = n(n({}, d), r);
    return (i = i.replace(e, (function(e) {
        return p[e](t, a)
    }))).replace(/@@@/g, (function() {
        return o.shift()
    }))
...
function C(t, e) {
    ...
    switch (t) {
        ...
        default:
            return console.warn("Unable to find icon for domain " + t + " (" + e + ")"), k
    }
}
var M = function(t) {
        O(window, "haptic", t)
    ...
    P = function(t, e) {
        return function(t, e, i) {
            ...
            return t.callService(o, s, {
                entity_id: e
            })
        }(t, e, x.includes(t.states[e].state))
    },
    A = function(t, e, i, s) {
        if (s || (s = {
                action: "more-info"
            }), !s.confirmation || s.confirmation.exemptions && s.confirmation.exemptions.some((function(t) {
                return t.user === e.user.id
            })) || (M("warning"), confirm(s.confirmation.text || "Are you sure you want to " + s.action + "?"))) switch (s.action) {
            case "more-info":
                (i.entity || i.camera_image) && O(t, "hass-more-info", {
                    entityId: i.entity ? i.entity : i.camera_image
                });
                break;
            case "navigate":
                s.navigation_path && function(t, e, i) {
                    void 0 === i && (i = !1), i ? history.replaceState(null, "", e) : history.pushState(null, "", e), O(window, "location-changed", {
                        replace: i
                    })
                }(0, s.navigation_path);
                break;
            case "url":
                ...
                break;
            case "toggle":
                i.entity && (P(e, i.entity), M("success"));
                break;
            case "call-service":
                if (!s.service) return void M("failure");
                var r = s.service.split(".", 2);
                e.callService(r[0], r[1], s.service_data), M("success");
                break;
            case "fire-dom-event":
                O(t, "ll-custom", s)
        }
    ...
    E = function(t, e, i, s) {
        var r;
        "double_tap" === s && i.double_tap_action ? r = i.double_tap_action : "hold" === s && i.hold_action ? r = i.hold_action : "tap" === s && i.tap_action && (r = i.tap_action), A(t, e, i, r)
    };
var $ = {
    ...
    N = {
        ...
        sensor: function(t) {
            ...
            if ("battery" === e) {
                ...
                var s = 10 * Math.round(i / 10);
                return s >= 100 ? "hass:battery" : s <= 0 ? "hass:battery-alert" : "hass:battery-" + s
            }
            var r = t.attributes.unit_of_measurement;
            return "°C" === r || "°F" === r ? "hass:thermometer" : C("sensor")
        },
        input_datetime: function(t) {
            return t.attributes.has_date ? t.attributes.has_time ? C("input_datetime") : "hass:calendar" : "hass:clock"
        }
    },
    j = function(t) {
        if (!t) return k;
        ...
        var e = w(t.entity_id);
        return e in N ? N[e](t) : C(e, t.state)
    },
    ...
    q = "function" == typeof U,
    G = "function" == typeof WeakMap,
    Y = function(t, e) {
        if (!t.constructor) return R(null);
        var i = t.constructor,
            s = t.__proto__ || L(t);
        if (i === e.Object) return s === e.Object.prototype ? {} : R(s);
        if (~I.call(i).indexOf("[native code]")) try {
            return new i
        } catch (t) {}
        return R(s)
    },
    W = function(t, e, i, s) {
        var r = Y(t, e);
        for (var o in s.set(t, r), t) D.call(t, o) && (r[o] = i(t[o], s));
        if (q) {
            var n = U(t),
                a = n.length;
            if (a)
                for (var c = 0, l = void 0; c < a; c++) l = n[c], B.call(t, l) && (r[l] = i(t[l], s))
        }
        return r
    },
    Z = function(t, e, i, s) {
        var r = Y(t, e);
        s.set(t, r);
        var o = q ? z(t).concat(U(t)) : z(t),
            n = o.length;
        if (n)
            for (var a = 0, c = void 0, l = void 0; a < n; a++)
                if ("callee" !== (c = o[a]) && "caller" !== c)
                    if (l = V(t, c)) {
                        l.get || l.set || (l.value = i(t[c], s));
                        try {
                            H(r, c, l)
                        } catch (t) {
                            r[c] = l.value
    ...
    K = Array.isArray,
    J = "undefined" != typeof self ? self : "undefined" != typeof window ? window : "undefined" != typeof global ? global : void(console && console.error && console.error('Unable to locate global object, returning "this".'));
...
function X(t, e) {
    var i = !(!e || !e.isStrict),
        ...
        o = function(t, e) {
            ...
            var n, a, c, l = t.constructor;
            if (l === s.Object) return r(t, s, o, e);
            if (K(t)) {
                if (i) return Z(t, s, o, e);
                var h = t.length;
                n = new l, e.set(t, n);
                for (var d = 0; d < h; d++) n[d] = o(t[d], e);
                return n
            }
            if (t instanceof s.Date) return new l(t.getTime());
            if (t instanceof s.RegExp) return (n = new l(t.source, t.flags || (c = "", (a = t).global && (c += "g"), a.ignoreCase && (c += "i"), a.multiline && (c += "m"), a.unicode && (c += "u"), a.sticky && (c += "y"), c))).lastIndex = t.lastIndex, n;
            if (s.Map && t instanceof s.Map) return n = new l, e.set(t, n), t.forEach((function(t, i) {
                n.set(i, o(t, e))
            })), n;
            if (s.Set && t instanceof s.Set) return n = new l, e.set(t, n), t.forEach((function(t) {
                n.add(o(t, e))
            })), n;
            if (s.Blob && t instanceof s.Blob) return t.slice(0, t.size, t.type);
            if (s.Buffer && s.Buffer.isBuffer(t)) return n = s.Buffer.allocUnsafe ? s.Buffer.allocUnsafe(t.length) : new l(t.length), e.set(t, n), t.copy(n), n;
            if (s.ArrayBuffer) {
                if (s.ArrayBuffer.isView(t)) return n = new l(t.buffer.slice(0)), e.set(t, n), n;
                if (t instanceof s.ArrayBuffer) return n = t.slice(0), e.set(t, n), n
            }
            return "function" == typeof t.then || t instanceof Error || s.WeakMap && t instanceof s.WeakMap || s.WeakSet && t instanceof s.WeakSet ? t : r(t, s, o, e)
        };
    return o(t, function() {
        if (G) return new WeakMap;
        var t = R({
            has: function(e) {
...
X.default = X, X.strict = function(t, e) {
    return X(t, {
        isStrict: !0,
 ...
 */
const Q = "undefined" != typeof window && null != window.customElements && void 0 !== window.customElements.polyfillWrapFlushCallback,
    tt = (t, e, i = null) => {
        for (; e !== i;) {
    ...
    et = `{{lit-${String(Math.random()).slice(2)}}}`,
    it = `\x3c!--${et}--\x3e`,
    st = new RegExp(`${et}|${it}`);
class rt {
    constructor(t, e) {
            ...
            if (null !== t) {
                if (n++, 1 === t.nodeType) {
                    if (t.hasAttributes()) {
                        ...
                        let s = 0;
                        for (let t = 0; t < i; t++) ot(e[t].name, "$lit$") && s++;
                        for (; s-- > 0;) {
                            const e = c[a],
                                i = ct.exec(e)[2],
                                s = i.toLowerCase() + "$lit$",
                    ...
                    "TEMPLATE" === t.tagName && (s.push(t), r.currentNode = t.content)
                    ...
                    if (e.indexOf(et) >= 0) {
                        ...
                        for (let e = 0; e < o; e++) {
                            ...
                            if ("" === o) i = at();
                                ...
                                const t = ct.exec(o);
                                null !== t && ot(t[2], "$lit$") && (o = o.slice(0, t.index) + t[1] + t[2].slice(0, -"$lit$".length) + t[3]), i = document.createTextNode(o)
                            }
                        ...
                        "" === r[o] ? (s.insertBefore(at(), t), i.push(t)) : t.data = r[o], a += o
                    }
                } else if (8 === t.nodeType)
                    if (t.data === et) {
                        const e = t.parentNode;
                        null !== t.previousSibling && n !== o || (n++, e.insertBefore(at(), t)), o = n, this.parts.push({
                            type: "node",
                            index: n
                        }), null === t.nextSibling ? t.data = "" : (i.push(t), n--), a++
                    } else {
                        let e = -1;
                        for (; - 1 !== (e = t.data.indexOf(et, e + 1));) this.parts.push({
                            type: "node",
                            index: -1
                        }), a++
                    }
...
const ot = (t, e) => {
    ...
    ct = /([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F "'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;
...
function lt(t, e) {
    const {
        ...
        parts: s
    } = t, r = document.createTreeWalker(i, 133, null, !1);
    let o = dt(s),
        n = s[o],
        a = -1,
        c = 0;
    ...
    for (; r.nextNode();) {
        ...
        for (t.previousSibling === h && (h = null), e.has(t) && (l.push(t), null === h && (h = t)), null !== h && c++; void 0 !== n && n.index === a;) n.index = null !== h ? -1 : n.index - c, o = dt(s, o), n = s[o]
    }
...
const ut = new WeakMap,
    ...
    gt = t => "function" == typeof t && ut.has(t),
    ft = {},
    bt = {};
/**
 * @license
...
class mt {
    ...
    _clone() {
        const t = Q ? this.template.element.content.cloneNode(!0) : document.importNode(this.template.element.content, !0),
            e = [],
        ...
        for (; o < i.length;)
            if (r = i[o], nt(r)) {
                for (; n < r.index;) n++, "TEMPLATE" === a.nodeName && (e.push(a), s.currentNode = a.content), null === (a = s.nextNode()) && (s.currentNode = e.pop(), a = s.nextNode());
                if ("node" === r.type) {
        ...
        return Q && (document.adoptNode(t), customElements.upgrade(t)), t
    }
}
/**
 * @license
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const _t = window.trustedTypes && trustedTypes.createPolicy("lit-html", {
        createHTML: t => t
    }),
    vt = ` ${et} `;
class yt {
    ...
    getHTML() {
        ...
        for (let s = 0; s < t; s++) {
            ...
            const o = ct.exec(t);
            e += null === o ? t + (i ? vt : it) : t.substr(0, o.index) + o[1] + o[2] + "$lit$" + o[3] + et
        }
    ...
    getTemplateElement() {
        ...
        let e = this.getHTML();
        return void 0 !== _t && (e = _t.createHTML(e)), t.innerHTML = e, t
    }
}
/**
 * @license
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const wt = t => null === t || !("object" == typeof t || "function" == typeof t),
    St = t => Array.isArray(t) || !(!t || !t[Symbol.iterator]);
class kt {
    constructor(t, e, i) {
    ...
    _getValue() {
        ...
        for (let r = 0; r < e; r++) {
            ...
            if (void 0 !== e) {
                const t = e.value;
                if (wt(t) || !St(t)) s += "string" == typeof t ? t : String(t);
                else
...
class xt {
    ...
    setValue(t) {
        t === ft || wt(t) && t === this.value || (this.value = t, gt(t) || (this.committer.dirty = !0))
    }
    commit() {
        for (; gt(this.value);) {
            const t = this.value;
...
class Ot {
    ...
    appendInto(t) {
        this.startNode = t.appendChild(at()), this.endNode = t.appendChild(at())
    }
    insertAfterNode(t) {
        this.startNode = t, this.endNode = t.nextSibling
    }
    appendIntoPart(t) {
        t.__insert(this.startNode = at()), t.__insert(this.endNode = at())
    }
    insertAfterPart(t) {
        t.__insert(this.startNode = at()), this.endNode = t.endNode, t.endNode = this.startNode
    }
    setValue(t) {
    ...
    commit() {
        ...
        const t = this.__pendingValue;
        t !== ft && (wt(t) ? t !== this.value && this.__commitText(t) : t instanceof yt ? this.__commitTemplateResult(t) : t instanceof Node ? this.__commitNode(t) : St(t) ? this.__commitIterable(t) : t === bt ? (this.value = bt, this.clear()) : this.__commitText(t))
    }
    __insert(t) {
    ...
    __commitTemplateResult(t) {
        ...
        if (this.value instanceof mt && this.value.template === e) this.value.update(t.values);
        else {
            const i = new mt(e, t.processor, this.options),
                s = i._clone();
    ...
    __commitIterable(t) {
        ...
        const e = this.value;
        let i, s = 0;
        for (const r of t) i = e[s], void 0 === i && (i = new Ot(this.options), e.push(i), 0 === s ? i.appendIntoPart(this) : i.insertAfterPart(e[s - 1])), i.setValue(r), i.commit(), s++;
        s < e.length && (e.length = s, this.clear(i && i.endNode))
    }
    clear(t = this.startNode) {
        tt(this.startNode.parentNode, t.nextSibling, this.endNode)
    }
}
class Tt {
    constructor(t, e, i) {
    ...
    commit() {
        ...
        if (this.__pendingValue === ft) return;
        const t = !!this.__pendingValue;
        this.value !== t && (t ? this.element.setAttribute(this.name, "") : this.element.removeAttribute(this.name), this.value = t), this.__pendingValue = ft
    }
}
class Ct extends kt {
    constructor(t, e, i) {
...
class At {
    ...
    commit() {
        ...
        const t = this.__pendingValue,
            ...
            s = null != t && (null == e || i);
        i && this.element.removeEventListener(this.eventName, this.__boundHandleEvent, this.__options), s && (this.__options = Et(t), this.element.addEventListener(this.eventName, this.__boundHandleEvent, this.__options)), this.value = t, this.__pendingValue = ft
    }
    handleEvent(t) {
...
function $t(t) {
    ...
    const s = t.strings.join(et);
    return i = e.keyString.get(s), void 0 === i && (i = new rt(t, t.getTemplateElement()), e.keyString.set(s, i)), e.stringsArray.set(t.strings, i), i
}
const Nt = new Map,
    jt = new WeakMap;
/**
...
class {
    handleAttributeExpressions(t, e, i, s) {
        const r = e[0];
        if ("." === r) {
            return new Ct(t, e.slice(1), i).parts
        }
        if ("@" === r) return [new At(t, e.slice(1), s.eventContext)];
        if ("?" === r) return [new Tt(t, e.slice(1), i)];
        return new kt(t, e, i).parts
    }
...
const Rt = (t, ...e) => new yt(t, e, "html", It)
    /**
     * @license
     * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
     * This code may only be used under the BSD style license found at
    ...
    Ht = (t, e) => `${t}--${e}`;
let Vt = !0;
void 0 === window.ShadyCSS ? Vt = !1 : void 0 === window.ShadyCSS.prepareTemplateDom && (console.warn("Incompatible ShadyCSS version detected. Please update to at least @webcomponents/webcomponentsjs@2.0.2 and @webcomponents/shadycss@1.3.1."), Vt = !1);
const zt = t => e => {
        const i = Ht(e.type, t);
        let s = Nt.get(i);
        void 0 === s && (s = {
        ...
        const o = e.strings.join(et);
        if (r = s.keyString.get(o), void 0 === r) {
            const i = e.getTemplateElement();
            Vt && window.ShadyCSS.prepareTemplateDom(i, t), r = new rt(e, i), s.keyString.set(o, r)
        }
    ...
    Ft = (t, e, i) => {
        ...
        i ? function(t, e, i = null) {
            ...
            for (; o.nextNode();) {
                c++;
                for (o.currentNode === i && (a = ht(e), i.parentNode.insertBefore(e, i)); - 1 !== n && r[n].index === c;) {
                    if (a > 0) {
                        for (; - 1 !== n;) r[n].index += a, n = dt(r, n);
                        return
                    }
                    n = dt(r, n)
                }
            }
        }(i, n, a.firstChild) : a.insertBefore(n, a.firstChild), window.ShadyCSS.prepareTemplateStyles(s, t);
...
class Gt extends HTMLElement {
    ...
    static getPropertyDescriptor(t, e, i) {
        return {
            ...
            set(s) {
                const r = this[t];
                this[e] = s, this.requestUpdateInternal(t, r, i)
            },
            configurable: !0,
            enumerable: !0
        }
    ...
    static getPropertyOptions(t) {
        return this._classProperties && this._classProperties.get(t) || qt
    }
    static finalize() {
    ...
    static _valueHasChanged(t, e, i = Bt) {
        return i(t, e)
    }
    ...
    static _propertyValueToAttribute(t, e) {
        ...
        const i = e.type,
            s = e.converter;
        return (s && s.toAttribute || Dt.toAttribute)(t, i)
    }
    initialize() {
    ...
    _propertyToAttribute(t, e, i = qt) {
        const s = this.constructor,
            r = s._attributeNameForProperty(t, i);
        if (void 0 !== r) {
    ...
    requestUpdateInternal(t, e, i) {
        ...
        if (void 0 !== t) {
            ...
            i = i || r.getPropertyOptions(t), r._valueHasChanged(this[t], e, i.hasChanged) ? (this._changedProperties.has(t) || this._changedProperties.set(t, e), !0 !== i.reflect || 16 & this._updateState || (void 0 === this._reflectingProperties && (this._reflectingProperties = new Map), this._reflectingProperties.set(t, i))) : s = !1
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const Yt = t => e => "function" == typeof e ? ((t, e) => (window.customElements.define(t, e), e))(t, e) : ((t, e) => {
        const {
            kind: i,
            elements: s
        } = e;
    ...
    Wt = (t, e) => "method" === e.kind && e.descriptor && !("value" in e.descriptor) ? Object.assign(Object.assign({}, e), {
        finisher(i) {
...
function Jt(t, e) {
    return (i, s) => {
        ...
        if (e) {
            const e = void 0 !== s ? s : i.key,
                o = "symbol" == typeof e ? Symbol() : "__" + e;
            r.get = function() {
                return void 0 === this[o] && (this[o] = this.renderRoot.querySelector(t)), this[o]
            }
        }
        return void 0 !== s ? Xt(r, i, s) : Qt(r, i)
    }
}
const Xt = (t, e, i) => {
    ...
    */
    ,
    te = window.ShadowRoot && (void 0 === window.ShadyCSS || window.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype,
    ee = Symbol();
class ie {
    constructor(t, e) {
        if (e !== ee) throw new Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");
        this.cssText = t
    }
    get styleSheet() {
        return void 0 === this._styleSheet && (te ? (this._styleSheet = new CSSStyleSheet, this._styleSheet.replaceSync(this.cssText)) : this._styleSheet = null), this._styleSheet
    }
    toString() {
        return this.cssText
    }
...
const se = (t, ...e) => {
    const i = e.reduce((e, i, s) => e + (t => {
        if (t instanceof ie) return t.cssText;
...
class oe extends Gt {
    ...
    update(t) {
        const e = this.render();
        super.update(t), e !== re && this.constructor.render(e, this.renderRoot, {
...
oe.finalized = !0, oe.render = (t, e, i) => {
    ...
    if (((t, e, i) => {
            ...
            void 0 === s && (tt(e, e.firstChild), jt.set(e, s = new Ot(Object.assign({
                templateFactory: $t
            }, i))), s.appendInto(e)), s.setValue(t), s.commit()
        })(t, a, Object.assign({
            templateFactory: zt(s)
        }, i)), n) {
        const t = jt.get(a);
        jt.delete(a);
        const i = t.value instanceof mt ? t.value.template : void 0;
        Ft(s, a, i), tt(e, e.firstChild), e.appendChild(a), jt.set(e, t)
...
const ae = new WeakMap,
    ce = pt(t => e => {
        ...
        let r = ae.get(e);
        void 0 === r && (s.setAttribute("class", i.strings.join(" ")), ae.set(e, r = new Set));
        const o = s.classList || new ne(s);
        r.forEach(e => {
            e in t || (o.remove(e), r.delete(e))
        });
        for (const e in t) {
            const i = t[e];
            i != r.has(e) && (i ? (o.add(e), r.add(e)) : (o.remove(e), r.delete(e)))
        }
    ...
    he = pt(t => e => {
        const i = le.get(e);
        if (void 0 === t && e instanceof xt) {
            if (void 0 !== i || !le.has(e)) {
    ...
    ue = pt(t => e => {
        ...
        let r = de.get(e);
        void 0 === r && (s.cssText = i.strings.join(" "), de.set(e, r = new Set)), r.forEach(e => {
            e in t || (r.delete(e), -1 === e.indexOf("-") ? s[e] = null : s.removeProperty(e))
        });
        for (const e in t) r.add(e), -1 === e.indexOf("-") ? s[e] = t[e] : s.setProperty(e, t[e])
    }),
...
class ge extends HTMLElement {
    ...
    bind(t, e) {
        ...
        const i = t => {
                let e, i;
                this.held = !1, t.touches ? (e = t.touches[0].pageX, i = t.touches[0].pageY) : (e = t.pageX, i = t.pageY), this.timer = window.setTimeout(() => {
                    this.startAnimation(e, i), this.held = !0
                }, this.holdTime)
            },
            s = i => {
                i.preventDefault(), ["touchend", "touchcancel"].includes(i.type) && void 0 === this.timer || (clearTimeout(this.timer), this.stopAnimation(), this.timer = void 0, this.held ? O(t, "action", {
                    action: "hold"
                }) : e.hasDoubleClick ? "click" === i.type && i.detail < 2 || !this.dblClickTimeout ? this.dblClickTimeout = window.setTimeout(() => {
                    this.dblClickTimeout = void 0, O(t, "action", {
                        action: "tap"
                    })
                }, 250) : (clearTimeout(this.dblClickTimeout), this.dblClickTimeout = void 0, O(t, "action", {
                    action: "double_tap"
                })) : O(t, "action", {
                    action: "tap"
                }))
        ...
        t.addEventListener("touchstart", i, {
            passive: !0
        }), t.addEventListener("touchend", s), t.addEventListener("touchcancel", s), t.addEventListener("mousedown", i, {
            passive: !0
        }), t.addEventListener("click", s), t.addEventListener("keyup", t => {
            13 === t.keyCode && s(t)
        })
    }
    startAnimation(t, e) {
...
customElements.define("action-handler-slider-button", ge);
const fe = (t, e) => {
        const i = (() => {
            const t = document.body;
            if (t.querySelector("action-handler-slider-button")) return t.querySelector("action-handler-slider-button");
            const e = document.createElement("action-handler-slider-button");
            return t.appendChild(e), e
        })();
        i && i.bind(t, e)
    },
    be = pt((t = {}) => e => {
        fe(e.committer.element, t)
    });
var me, _e, ve, ye;
! function(t) {
    t.TOGGLE = "toggle", t.CUSTOM = "custom"
}(me || (me = {})),
function(t) {
    t.LEFT_RIGHT = "left-right", t.TOP_BOTTOM = "top-bottom", t.BOTTOM_TOP = "bottom-top"
}(_e || (_e = {})),
function(t) {
    t.SOLID = "solid", t.GRADIENT = "gradient", t.TRIANGLE = "triangle", t.STRIPED = "striped", t.CUSTOM = "custom"
}(ve || (ve = {})),
function(t) {
    t.LIGHT = "light", t.SWITCH = "switch", t.FAN = "fan", t.COVER = "cover", t.INPUT_BOOLEAN = "input_boolean", t.MEDIA_PLAYER = "media_player", t.CLIMATE = "climate", t.LOCK = "lock"
}(ye || (ye = {}));
const we = {
        mode: me.TOGGLE,
        icon: "mdi:power",
    ...
    ke = {
        direction: _e.LEFT_RIGHT,
        background: ve.SOLID,
        use_percentage_bg_opacity: !1,
        use_state_color: !1,
        show_track: !1,
        toggle_on_click: !1,
        force_square: !1
    ...
    xe = new Map([
        ...
        [ye.COVER, {
            direction: _e.TOP_BOTTOM,
            background: ve.STRIPED,
            use_state_color: !1,
            use_percentage_bg_opacity: !1,
            toggle_on_click: !1,
            show_track: !1,
...
function Ne(t, e, i) {
    t = Me(t, 255), e = Me(e, 255), i = Me(i, 255);
...
function Re(t, e, i, s) {
    var r = [$e(Math.round(t).toString(16)), $e(Math.round(e).toString(16)), $e(Math.round(i).toString(16))];
    return s && r[0].startsWith(r[0].charAt(1)) && r[1].startsWith(r[1].charAt(1)) && r[2].startsWith(r[2].charAt(1)) ? r[0].charAt(0) + r[1].charAt(0) + r[2].charAt(0) : r.join("")
}
...
function Ve(t) {
    ...
    t.COLOR_TEMP = "color_temp", t.BRIGHTNESS = "brightness", t.BRIGHTNESS_PCT = "brightness_pct", t.HUE = "hue", t.SATURATION = "saturation", t.ON_OFF = "onoff"
}(Oe || (Oe = {})),
function(t) {
    t.COLOR_TEMP = "color_temp", t.BRIGHTNESS = "brightness", t.HS = "hs", t.ON_OFF = "onoff"
}(Te || (Te = {})),
function(t) {
    t.POSITION = "position", t.TILT = "tilt"
}(Ce || (Ce = {}));
var ze = {
    aliceblue: "#f0f8ff",
    antiquewhite: "#faebd7",
...
function Ue(t) {
    ...
    return "string" == typeof t && (t = function(t) {
        ...
        if (i = Be.rgba.exec(t)) return {
            r: i[1],
            g: i[2],
            b: i[3],
            a: i[4]
        };
        if (i = Be.hsl.exec(t)) return {
            h: i[1],
            s: i[2],
            l: i[3]
        };
        if (i = Be.hsla.exec(t)) return {
            h: i[1],
            s: i[2],
            l: i[3],
            a: i[4]
        };
        if (i = Be.hsv.exec(t)) return {
            h: i[1],
            s: i[2],
            v: i[3]
        };
        if (i = Be.hsva.exec(t)) return {
            h: i[1],
            s: i[2],
            v: i[3],
            a: i[4]
        };
        if (i = Be.hex8.exec(t)) return {
            r: Ve(i[1]),
            g: Ve(i[2]),
            b: Ve(i[3]),
            a: He(i[4]),
        ...
        if (i = Be.hex6.exec(t)) return {
            r: Ve(i[1]),
            g: Ve(i[2]),
            b: Ve(i[3]),
            format: e ? "name" : "hex"
        };
        if (i = Be.hex4.exec(t)) return {
            r: Ve(i[1] + i[1]),
            g: Ve(i[2] + i[2]),
            b: Ve(i[3] + i[3]),
            a: He(i[4] + i[4]),
        ...
        return !1
    }(t)), "object" == typeof t && (qe(t.r) && qe(t.g) && qe(t.b) ? (e = function(t, e, i) {
        return {
            r: 255 * Me(t, 255),
            g: 255 * Me(e, 255),
            b: 255 * Me(i, 255)
        }
    }(t.r, t.g, t.b), n = !0, a = "%" === String(t.r).substr(-1) ? "prgb" : "rgb") : qe(t.h) && qe(t.s) && qe(t.v) ? (s = Ee(t.s), r = Ee(t.v), e = function(t, e, i) {
        t = 6 * Me(t, 360), e = Me(e, 100), i = Me(i, 100);
        var s = Math.floor(t),
            r = t - s,
            o = i * (1 - e),
            n = i * (1 - r * e),
    ...
    }(t.h, s, r), n = !0, a = "hsv") : qe(t.h) && qe(t.s) && qe(t.l) && (s = Ee(t.s), o = Ee(t.l), e = function(t, e, i) {
        var s, r, o;
        if (t = Me(t, 360), e = Me(e, 100), i = Me(i, 100), 0 === e) r = i, o = i, s = i;
        else {
            var n = i < .5 ? i * (1 + e) : i + e - i * e,
                a = 2 * i - n;
            s = je(a, n, t + 1 / 3), r = je(a, n, t), o = je(a, n, t - 1 / 3)
        }
        return {
            r: 255 * s,
            g: 255 * r,
    ...
    }(t.h, s, o), n = !0, a = "hsl"), Object.prototype.hasOwnProperty.call(t, "a") && (i = t.a)), i = Ae(i), {
        ok: n,
        format: t.format || a,
...
var Ge = function() {
    ...
    return t.prototype.isDark = function() {
        ...
        var t = this.toRgb(),
            ...
            i = t.g / 255,
            s = t.b / 255;
        return .2126 * (e <= .03928 ? e / 12.92 : Math.pow((e + .055) / 1.055, 2.4)) + .7152 * (i <= .03928 ? i / 12.92 : Math.pow((i + .055) / 1.055, 2.4)) + .0722 * (s <= .03928 ? s / 12.92 : Math.pow((s + .055) / 1.055, 2.4))
    }, t.prototype.getAlpha = function() {
        return this.a
    }, t.prototype.setAlpha = function(t) {
        return this.a = Ae(t), this.roundA = Math.round(100 * this.a) / 100, this
        ...
        return 1 === this.a ? "hsv(" + e + ", " + i + "%, " + s + "%)" : "hsva(" + e + ", " + i + "%, " + s + "%, " + this.roundA + ")"
        ...
        return 1 === this.a ? "hsl(" + e + ", " + i + "%, " + s + "%)" : "hsla(" + e + ", " + i + "%, " + s + "%, " + this.roundA + ")"
    }, t.prototype.toHex = function(t) {
        return void 0 === t && (t = !1), Re(this.r, this.g, this.b, t)
    }, t.prototype.toHexString = function(t) {
        return void 0 === t && (t = !1), "#" + this.toHex(t)
    }, t.prototype.toHex8 = function(t) {
        return void 0 === t && (t = !1),
            function(t, e, i, s, r) {
                var o, n = [$e(Math.round(t).toString(16)), $e(Math.round(e).toString(16)), $e(Math.round(i).toString(16)), $e((o = s, Math.round(255 * parseFloat(o)).toString(16)))];
        ...
        for (var t = "#" + Re(this.r, this.g, this.b, !1), e = 0, i = Object.entries(ze); e < i.length; e++) {
            var s = i[e],
                r = s[0];
            if (t === s[1]) return r
        }
        ...
        var i = !1,
            s = this.a < 1 && this.a >= 0;
        return e || !s || !t.startsWith("hex") && "name" !== t ? ("rgb" === t && (i = this.toRgbString()), "prgb" === t && (i = this.toPercentageRgbString()), "hex" !== t && "hex6" !== t || (i = this.toHexString()), "hex3" === t && (i = this.toHexString(!0)), "hex4" === t && (i = this.toHex8String(!0)), "hex8" === t && (i = this.toHex8String()), "name" === t && (i = this.toName()), "hsl" === t && (i = this.toHslString()), "hsv" === t && (i = this.toHsvString()), i || this.toHexString()) : "name" === t && 0 === this.a ? this.toName() : this.toRgbString()
        ...
        void 0 === e && (e = 10);
        var i = this.toHsl();
        return i.l += e / 100, i.l = Pe(i.l), new t(i)
        ...
        void 0 === e && (e = 10);
        var i = this.toHsl();
        return i.s -= e / 100, i.s = Pe(i.s), new t(i)
        ...
        var i = this.toHsl(),
            s = (i.h + e) % 360;
        return i.h = s < 0 ? 360 + s : s, new t(i)
        ...
        var s = this.toHsl(),
            r = 360 / i,
            o = [this];
        for (s.h = (s.h - (r * e >> 1) + 720) % 360; --e;) s.h = (s.h + r) % 360, o.push(new t(s));
        return o
        ...
        void 0 === e && (e = 6);
        for (var i = this.toHsv(), s = i.h, r = i.s, o = i.v, n = [], a = 1 / e; e--;) n.push(new t({
            h: s,
            s: r,
            v: o
        })), o = (o + a) % 1;
        ...
        for (var i = this.toHsl(), s = i.h, r = [this], o = 360 / e, n = 1; n < e; n++) r.push(new t({
            h: (s + n * o) % 360,
            s: i.s,
            l: i.l
        }));
...
function Ye(t, e) {
    return void 0 === t && (t = ""), void 0 === e && (e = {}), new Ge(t, e)
}

function We(t) {
    return Object.keys(t).map(e => t[e]).filter(t => "string" == typeof t)
}
const Ze = (t, e, i) => {
    if (1 !== e.length) return t[e[0]] || (t[e[0]] = {}), Ze(t[e[0]], e.slice(1), i);
    t[e[0]] = i
};

function Ke(t) {
    const e = w(t) || ye.LIGHT;
    return X(xe.get(e) || ke)
}

function Je(t, e, i) {
    const s = new Ge("rgb(255, 160, 0)"),
        r = new Ge("rgb(166, 209, 255)"),
        o = new Ge("white"),
        n = (t - e) / (i - e) * 100;
    return n < 50 ? Ye(r).mix(o, 2 * n).toRgbString() : Ye(o).mix(s, 2 * (n - 50)).toRgbString()
}
...
function Qe(t, e, i) {
    return Math.floor(t * (i - e) / 100 + e)
}
class ti {
    constructor(t) {
        this._sliderPrevColor = "", this._config = t
    }
    set hass(t) {
        this._hass = t
    }
    ...
    get domain() {
        return S(this.stateObj)
    }
    get name() {
        var t, e;
        return this._config.name ? this._config.name : (null === (e = null === (t = this.stateObj) || void 0 === t ? void 0 : t.attributes) || void 0 === e ? void 0 : e.friendly_name) ? this.stateObj.attributes.friendly_name : ""
    }
    get icon() {
        var t, e, i;
        return "string" == typeof(null === (t = this._config.icon) || void 0 === t ? void 0 : t.icon) && (null === (e = this._config.icon) || void 0 === e ? void 0 : e.icon.length) ? this._config.icon.icon : (null === (i = this.stateObj.attributes) || void 0 === i ? void 0 : i.icon) ? this.stateObj.attributes.icon : C(this.domain, this.stateObj.state)
    }
    get value() {
        return this._value ? Math.round(this._value / this.step) * this.step : this.min
    }
    set value(t) {
        t !== this.value && (this._value = t)
    }
    get targetValue() {
        return 0 === this._targetValue ? 0 : this._targetValue ? Math.round(this._targetValue / this.step) * this.step : this.value ? this.value : 0
    }
    set targetValue(t) {
        t !== this.targetValue && (this._targetValue = t)
    }
    get label() {
    ...
    get hasToggle() {
        var t, e;
        return null !== (e = null === (t = this._config.slider) || void 0 === t ? void 0 : t.toggle_on_click) && void 0 !== e && e
    }
    get toggleValue() {
    ...
    get state() {
        var t;
        return null === (t = this.stateObj) || void 0 === t ? void 0 : t.state
    }
    get isOff() {
        return 0 === this.percentage
    }
    get isUnavailable() {
        return !this.state || "unavailable" === this.state
    }
    ...
    get min() {
        var t, e, i;
        return null !== (i = null !== (e = null === (t = this._config.slider) || void 0 === t ? void 0 : t.min) && void 0 !== e ? e : this._min) && void 0 !== i ? i : 0
    }
    get max() {
        var t, e, i;
    ...
    get step() {
        var t, e, i;
        return null !== (i = null !== (e = null === (t = this._config.slider) || void 0 === t ? void 0 : t.step) && void 0 !== e ? e : this._step) && void 0 !== i ? i : 5
    }
    get invert() {
        var t, e, i;
        return null !== (i = null !== (e = null === (t = this._config.slider) || void 0 === t ? void 0 : t.invert) && void 0 !== e ? e : this._invert) && void 0 !== i && i
    }
    ...
    get valueFromPercentage() {
        return Qe(this.percentage, this.min, this.max)
    }
    ...
    get iconFilter() {
        var t;
        return (null === (t = this._config.icon) || void 0 === t ? void 0 : t.use_state_color) && 0 !== this.percentage ? `brightness(${(this.percentage+100)/2}%)` : "brightness(100%)"
    }
    get iconColor() {
        var t;
        if (null === (t = this._config.icon) || void 0 === t ? void 0 : t.use_state_color) {
            if (!this.stateObj.attributes.hs_color) return this.percentage > 0 ? "var(--paper-item-icon-active-color, #fdd835)" : "var(--paper-item-icon-color, #44739e)";
            {
                const [t, e] = this.stateObj.attributes.hs_color;
                if (e > 10) return `hsl(${t}, 100%, ${100-e/2}%)`
            }
        }
        return ""
    }
    ...
    get sliderFilter() {
        var t;
        return (null === (t = this._config.slider) || void 0 === t ? void 0 : t.use_percentage_bg_opacity) && 0 !== this.percentage && this._config.slider.background !== ve.GRADIENT ? `brightness(${(this.percentage+100)/2}%)` : "brightness(100%)"
    }
    get sliderColor() {
        var t;
        if (null === (t = this._config.slider) || void 0 === t ? void 0 : t.use_state_color)
            if (this.stateObj.attributes.hs_color) {
                const [t, e] = this.stateObj.attributes.hs_color;
                if (e > 10) {
                    const i = `hsl(${t}, 100%, ${100-e/2}%)`;
                    return this._sliderPrevColor = i, i
                }
            } else {
                if (this.stateObj.attributes.color_temp && this.stateObj.attributes.min_mireds && this.stateObj.attributes.max_mireds) {
                    const t = Je(this.stateObj.attributes.color_temp, this.stateObj.attributes.min_mireds, this.stateObj.attributes.max_mireds);
                    return this._sliderPrevColor = t, t
                }
                if (this._sliderPrevColor.startsWith("hsl") || this._sliderPrevColor.startsWith("rgb")) return this._sliderPrevColor
            } return "inherit"
    }
    moveSlider(t, {
        left: e,
        ...
        let o = this.calcMovementPercentage(t, {
            left: e,
            top: i,
            width: s,
            height: r
        ...
        var n, a, c;
        return o = this.applyStep(o), n = o, a = 0, c = 100, o = isNaN(n) || isNaN(a) || isNaN(c) ? 0 : n > c ? c : n < a ? a : n, this.isValuePercentage || (o = Qe(o, this.min, this.max)), o
    }
    calcMovementPercentage(t, {
        left: e,
        top: i,
        width: s,
        height: r
        ...
        var o;
        let n;
        switch (null === (o = this._config.slider) || void 0 === o ? void 0 : o.direction) {
            case _e.LEFT_RIGHT:
                n = Xe(t.clientX, e, s), this.invert && (n = 100 - n);
                break;
            case _e.TOP_BOTTOM:
                n = Xe(t.clientY, i, r), this.invert && (n = 100 - n);
                break;
            case _e.BOTTOM_TOP:
                n = Xe(t.clientY, i, r), this.invert || (n = 100 - n)
        }
    ...
    log(t = "", e = "") {
        this._config.debug && console.log(`${this._config.entity}: ${t}`, e)
    }
}
class ei extends ti {
    constructor() {
        super(...arguments), this._invert = !1
    }
    get _value() {
    ...
    get isOff() {
        return x.includes(this.state)
    }
    get _step() {
        var t;
        return (null === (t = this.stateObj.attributes) || void 0 === t ? void 0 : t.target_temp_step) || 1
    }
    get _min() {
        var t;
        return (null === (t = this.stateObj.attributes) || void 0 === t ? void 0 : t.min_temp) || 7
    }
    get _max() {
        var t;
        return (null === (t = this.stateObj.attributes) || void 0 === t ? void 0 : t.max_temp) || 35
    }
    get isValuePercentage() {
        return !1
    }
    get label() {
        const t = this._hass.config.unit_system.temperature,
            e = (i = this.state) && i[0].toUpperCase() + i.slice(1) || "";
        var i;
        return `${this.targetValue}${t} | ${e}`
    }
}
class ii extends ti {
    constructor() {
        super(...arguments), this._min = 0, this._invert = !0
    }
    get attribute() {
        var t, e, i, s;
        return (null === (e = null === (t = this._config.slider) || void 0 === t ? void 0 : t.attribute) || void 0 === e ? void 0 : e.length) && this.allowedAttributes.includes(null === (i = this._config.slider) || void 0 === i ? void 0 : i.attribute) ? null === (s = this._config.slider) || void 0 === s ? void 0 : s.attribute : Ce.POSITION
    }
    get icon() {
        var t, e;
        return "string" == typeof(null === (t = this._config.icon) || void 0 === t ? void 0 : t.icon) && (null === (e = this._config.icon) || void 0 === e ? void 0 : e.icon.length) ? this._config.icon.icon : j(this.stateObj)
    }
    get allowedAttributes() {
        return We(Ce)
    }
    get _value() {
        ...
        switch (this.attribute) {
            case Ce.POSITION:
                return "closed" === (null === (t = this.stateObj) || void 0 === t ? void 0 : t.state) ? 0 : this.stateObj.attributes.current_position;
            case Ce.TILT:
    ...
    set _value(t) {
        if (this.hasSlider) switch (this.attribute) {
            case Ce.POSITION:
            ...
            const e = t > 0 ? "open_cover" : "close_cover";
            this._hass.callService("cover", e, {
                entity_id: this.stateObj.entity_id
            })
        }
    }
    ...
    get label() {
        const t = this._hass.localize("component.cover.state._." + this.state),
            e = this._hass.localize("component.cover.state._.closed"),
            i = this._hass.localize("component.cover.state._.open");
        if (!this.hasSlider) return t;
        switch (this.attribute) {
            case Ce.POSITION:
                return 0 === this.percentage ? this.invert ? i : e : 100 === this.percentage ? this.invert ? e : i : this.percentage + "%";
            case Ce.TILT:
    ...
    get hasSlider() {
        switch (this.attribute) {
            case Ce.POSITION:
                ...
                if ("supported_features" in this.stateObj.attributes && 4 & this.stateObj.attributes.supported_features) return !0;
                break;
            case Ce.TILT:
                if ("current_tilt_position" in this.stateObj.attributes) return !0;
                if ("supported_features" in this.stateObj.attributes && 128 & this.stateObj.attributes.supported_features) return !0;
                break;
            default:
                return !1
        }
...
class si extends ti {
    constructor() {
        super(...arguments), this._min = 0, this._invert = !1
    }
    get _value() {
        return this.isUnavailable || x.includes(this.state) ? 0 : this.hasSlider ? this.stateObj.attributes.percentage : 1
    }
    set _value(t) {
        const e = t > 0 ? "turn_on" : "turn_off";
        t > 0 && this.hasSlider ? this._hass.callService("fan", "set_percentage", {
            entity_id: this.stateObj.entity_id,
            percentage: t
        }) : this._hass.callService("fan", e, {
            entity_id: this.stateObj.entity_id
        })
    }
    get _step() {
    ...
    get label() {
        return this.percentage > 0 ? this.hasSlider ? this.percentage + "%" : this._hass.localize("component.fan.state._.on") : this._hass.localize("component.fan.state._.off")
    }
    get hasSlider() {
    ...
    get iconRotateSpeed() {
        let t = 0;
        return this.percentage > 0 && (t = 3 - this.percentage / 100 * 2), t + "s"
    }
}
class ri extends ti {
    constructor() {
        super(...arguments), this._min = 0, this._max = 1, this._invert = !1
    }
    get _value() {
        return x.includes(this.stateObj.state) ? 0 : 1
    }
    set _value(t) {
        const e = t > 0 ? "turn_on" : "turn_off";
        this._hass.callService("input_boolean", e, {
            entity_id: this.stateObj.entity_id
        })
    }
    get _step() {
    ...
    get label() {
        return this.percentage > 0 ? this._hass.localize("component.input_boolean.state._.on") : this._hass.localize("component.input_boolean.state._.off")
    }
}
const oi = {
    hue: 0,
...
class ni extends ti {
    constructor() {
        super(...arguments), this._step = 1, this._invert = !1
    }
    get attribute() {
        var t, e, i, s, r;
        const o = null === (t = this._config.slider) || void 0 === t ? void 0 : t.attribute;
        let n = Oe.BRIGHTNESS_PCT,
            a = [];
        if (Array.isArray(null === (i = null === (e = this.stateObj) || void 0 === e ? void 0 : e.attributes) || void 0 === i ? void 0 : i.supported_color_modes) && (a = null === (r = null === (s = this.stateObj) || void 0 === s ? void 0 : s.attributes) || void 0 === r ? void 0 : r.supported_color_modes), 1 === a.length && a[0] === Oe.ON_OFF && (n = Oe.ON_OFF), (null == o ? void 0 : o.length) && this.allowedAttributes.includes(o)) switch (n = o, o) {
            case Oe.COLOR_TEMP:
                a.includes("color_temp") || (n = Oe.BRIGHTNESS_PCT);
                break;
            case Oe.HUE:
            case Oe.SATURATION:
                a.includes("hs") || (n = Oe.BRIGHTNESS_PCT)
        }
        return n
    }
    get allowedAttributes() {
    ...
    get colorMode() {
        var t, e;
        return null === (e = null === (t = this.stateObj) || void 0 === t ? void 0 : t.attributes) || void 0 === e ? void 0 : e.color_mode
    }
    get _value() {
        if (!this.stateObj || x.includes(this.state)) return this.isValuePercentage ? 0 : this.min;
        const t = this.stateObj.attributes;
        switch (this.attribute) {
            case Oe.COLOR_TEMP:
                return t.color_temp ? Math.round(t.color_temp) : this.min;
            case Oe.BRIGHTNESS:
                return Math.round(t.brightness);
            case Oe.BRIGHTNESS_PCT:
                return Math.round(100 * t.brightness / 255);
            case Oe.ON_OFF:
                return 1;
            case Oe.HUE:
            case Oe.SATURATION:
                return t.hs_color ? Math.round(t.hs_color[oi[this.attribute]]) : 0;
            default:
                return 0
        }
    }
    set _value(t) {
        ...
        let e, i = this.attribute,
            s = t > 0 ? "turn_on" : "turn_off",
            r = {
                entity_id: this.stateObj.entity_id
            };
        switch (i) {
            case Oe.BRIGHTNESS:
            case Oe.BRIGHTNESS_PCT:
                (t = i === Oe.BRIGHTNESS ? Math.round(t) : Math.round(t / 100 * 255)) ? (i = "brightness", r = Object.assign(Object.assign({}, r), {
                    [i]: t
                })) : s = "turn_off";
                break;
            case Oe.HUE:
            case Oe.SATURATION:
                e = this.stateObj.attributes.hs_color || [0, 0], e[oi[i]] = t, t = e, i = "hs_color", s = "turn_on", r = Object.assign(Object.assign({}, r), {
                    [i]: t
                });
                break;
            case Oe.COLOR_TEMP:
                i = "color_temp", s = "turn_on", r = Object.assign(Object.assign({}, r), {
                    [i]: t
                })
        }
        this._hass.callService("light", s, Object.assign({}, r))
    }
    get _min() {
        var t;
        switch (this.attribute) {
            case Oe.COLOR_TEMP:
                return this.stateObj && (null === (t = this.stateObj.attributes) || void 0 === t ? void 0 : t.min_mireds) ? this.stateObj.attributes.min_mireds : 153;
            default:
                return 0
        }
    }
    get _max() {
        ...
        switch (this.attribute) {
            case Oe.COLOR_TEMP:
                return this.stateObj && (null === (t = this.stateObj.attributes) || void 0 === t ? void 0 : t.max_mireds) ? this.stateObj.attributes.max_mireds : 500;
            case Oe.BRIGHTNESS:
                return 255;
            case Oe.HUE:
                return 360;
    ...
    get isOff() {
        switch (this.attribute) {
            ...
            case Oe.ON_OFF:
                return x.includes(this.state);
            default:
                return this.colorMode === Te.ON_OFF ? x.includes(this.state) : 0 === this.percentage
        }
    }
    get label() {
        if (this.isOff) return this._hass.localize("component.light.state._.off");
        if (this.colorMode === Te.ON_OFF) return this._hass.localize("component.light.state._.on");
        switch (this.attribute) {
            case Oe.ON_OFF:
    ...
    get hasToggle() {
        var t, e, i, s, r, o;
        let n = [];
        return Array.isArray(null === (e = null === (t = this.stateObj) || void 0 === t ? void 0 : t.attributes) || void 0 === e ? void 0 : e.supported_color_modes) && (n = null === (s = null === (i = this.stateObj) || void 0 === i ? void 0 : i.attributes) || void 0 === s ? void 0 : s.supported_color_modes), 1 === n.length && n[0] === Oe.ON_OFF || null !== (o = null === (r = this._config.slider) || void 0 === r ? void 0 : r.toggle_on_click) && void 0 !== o && o
    }
    get hasSlider() {
        var t, e;
        if (!this.stateObj) return !1;
        switch (this.attribute) {
            case Oe.ON_OFF:
                return !1;
            case Oe.BRIGHTNESS:
            case Oe.BRIGHTNESS_PCT:
                return "brightness" in this.stateObj.attributes || !!("supported_features" in this.stateObj.attributes && 1 & (null === (e = null === (t = this.stateObj) || void 0 === t ? void 0 : t.attributes) || void 0 === e ? void 0 : e.supported_features));
            case Oe.COLOR_TEMP:
                return "color_temp" in this.stateObj.attributes || !!("supported_features" in this.stateObj.attributes && 2 & this.stateObj.attributes.supported_features);
            case Oe.HUE:
            case Oe.SATURATION:
                return "hs_color" in this.stateObj.attributes || !!("supported_features" in this.stateObj.attributes && 16 & this.stateObj.attributes.supported_features);
            default:
                return !1
        }
    }
    get sliderColor() {
        ...
        let e = "inherit";
        if (null === (t = this._config.slider) || void 0 === t ? void 0 : t.use_state_color)
            if (this.stateObj.attributes.hs_color && this.attribute !== Oe.COLOR_TEMP) {
                const [t, i] = this.stateObj.attributes.hs_color;
                let s = t,
                    r = i;
                switch (this.attribute) {
                    case Oe.HUE:
                        s = this.valueFromPercentage;
                        break;
                    case Oe.SATURATION:
                        r = this.percentage
                }
                r > 10 && (e = `hsl(${s}, 100%, ${100-r/2}%)`, this._sliderPrevColor = e)
            } else if (this.attribute === Oe.HUE || this.attribute === Oe.SATURATION) {
            let t = 0,
                i = 20;
            switch (this.attribute) {
                case Oe.HUE:
                    t = this.valueFromPercentage;
                    break;
                case Oe.SATURATION:
                    i = this.percentage
            }
            i > 10 && (e = `hsl(${t}, 100%, ${100-i/2}%)`, this._sliderPrevColor = e)
        } else this.stateObj.attributes.color_temp && this.stateObj.attributes.min_mireds && this.stateObj.attributes.max_mireds ? (e = Je(this.attribute === Oe.COLOR_TEMP ? this.valueFromPercentage : this.stateObj.attributes.color_temp, this.stateObj.attributes.min_mireds, this.stateObj.attributes.max_mireds), this._sliderPrevColor = e) : this.attribute === Oe.COLOR_TEMP ? (e = Je(this.valueFromPercentage, 153, 500), this._sliderPrevColor = e) : (this._sliderPrevColor.startsWith("hsl") || this._sliderPrevColor.startsWith("rgb")) && (e = this._sliderPrevColor);
        return e
    }
}
class ai extends ti {
    ...
    set _value(t) {
        const e = t > 0 ? "lock" : "unlock";
        this._hass.callService("lock", e, {
            entity_id: this.stateObj.entity_id
        })
    }
    get _step() {
    ...
    get label() {
        return this.percentage > 0 ? this._hass.localize("component.lock.state._.unlocked") : this._hass.localize("component.lock.state._.locked")
    }
}
class ci extends ti {
    constructor() {
        ...
        this._step = 1;
        this._invert = !1;
        // Kein _max hier im Konstruktor setzen – wird dynamisch über Getter gelesen
    }
    ...
    get label() {
        ...
        if (this.stateObj.attributes.volume_level != null) return this.percentage + "%";
        return this._hass.localize("component.media_player.state._." + this.state);
    }
}
class li extends ti {
    constructor() {
    ...
    get label() {
        return this.percentage > 0 ? this._hass.localize("component.switch.state._.on") : this._hass.localize("component.switch.state._.off")
    }
}
var hi = {
        version: "v",
...
function ps(t, e = "", i = "") {
    ...
    let r;
    try {
        r = t.split(".").reduce((t, e) => t[e], us[s])
    } catch (e) {
        r = t.split(".").reduce((t, e) => t[e], us.en)
    }
    return void 0 === r && (r = t.split(".").reduce((t, e) => t[e], us.en)), "" !== e && "" !== i && (r = r.replace(e, i)), r
}
let gs = class extends oe {
    constructor() {
        super(...arguments), this._initialized = !1, this.directions = We(_e), this.backgrounds = We(ve), this.actionModes = We(me), this.actions = ["more-info", "toggle", "navigate", "url", "call-service", "none"]
    }
    async setConfig(t) {
        this._config = t, void 0 === this._helpers && await this.loadCardHelpers()
    }
    shouldUpdate() {
    ...
    get _name() {
        var t;
        return (null === (t = this._config) || void 0 === t ? void 0 : t.name) || ""
    }
    get _show_name() {
        var t, e;
        return void 0 === (null === (t = this._config) || void 0 === t ? void 0 : t.show_name) || (null === (e = this._config) || void 0 === e ? void 0 : e.show_name)
    }
    get _show_state() {
        var t, e;
        return void 0 === (null === (t = this._config) || void 0 === t ? void 0 : t.show_state) || (null === (e = this._config) || void 0 === e ? void 0 : e.show_state)
    }
    get _compact() {
        var t, e;
        return "boolean" == typeof(null === (t = this._config) || void 0 === t ? void 0 : t.compact) && (null === (e = this._config) || void 0 === e ? void 0 : e.compact)
    }
    get _entity() {
        var t;
        return (null === (t = this._config) || void 0 === t ? void 0 : t.entity) || ""
    }
    get _icon() {
        var t;
        return (null === (t = this._config) || void 0 === t ? void 0 : t.icon) || Se
    }
    get _slider() {
        var t;
        return (null === (t = this._config) || void 0 === t ? void 0 : t.slider) || ke
    }
    get _action_button() {
        var t;
        return (null === (t = this._config) || void 0 === t ? void 0 : t.action_button) || we
    }
    render() {
        var t, e;
        return this.hass && this._helpers ? (this._helpers.importMoreInfoControl("climate"), Rt`
    ...
    _valueChangedSelect(t) {
        var e;
        const i = t.detail.value;
        i && this._changeValue(null === (e = i.parentElement) || void 0 === e ? void 0 : e.configValue, i.itemValue)
    }
    _valueChangedEntity(t) {
        var e, i;
        const s = t.target,
            r = null === (e = t.detail) || void 0 === e ? void 0 : e.value,
            o = w(r) !== w((null === (i = this._config) || void 0 === i ? void 0 : i.entity) || "light.dummy");
        if (this._changeValue("name", ""), this._changeValue("icon.icon", ""), this._changeValue(s.configValue, r), o) {
            const t = X(this._config);
            Ze(t, ["slider"], Ke(r)), this._config = t, O(this, "config-changed", {
                config: this._config
            })
        }
    }
    _valueChanged(t) {
        var e;
        const i = t.target,
            s = null === (e = t.detail) || void 0 === e ? void 0 : e.value;
        this._changeValue(i.configValue, void 0 !== i.checked ? i.checked : s)
    }
    _changeValue(t, e) {
        if (this._config && this.hass && (void 0 === this["_" + t] || this["_" + t] !== e)) {
            if (t) {
                const i = X(this._config);
                Ze(i, [...t.split(".")], e), this._config = i, "" === e && delete this._config[t]
            }
...
let fs = class extends oe {
    ...
    setConfig(t) {
        if (!t) throw new Error(ps("common.invalid_configuration"));
        if (!t.entity) throw new Error(ps("common.invalid_configuration"));
        ...
        this.ctrl = class {
            static getInstance(t) {
                ...
                if (void 0 === i[e]) throw new Error("Unsupported entity type: " + e);
                return new i[e](t)
            }
    ...
    shouldUpdate(t) {
        ...
        const e = t.get("hass");
        return e && e.themes === this.hass.themes && e.language === this.hass.language ? function(t, e, i) {
            ...
            return !1
        }(this, t, !1) : (this.ctrl.log("shouldUpdate", "forced true"), !0)
    }
    updated(t) {
        this.updateValue(this.ctrl.value, !1), this.animateActionEnd();
        const e = t.get("hass"),
            i = t.get("config");
        (null == e ? void 0 : e.themes) === this.hass.themes && (null == i ? void 0 : i.theme) === this.config.theme || (this.ctrl.log("Theme", "updated"), function(t, e, i, s) {
            void 0 === s && (s = !1), t._themes || (t._themes = {});
            var r = e.default_theme;
            ("default" === i || i && e.themes[i]) && (r = i);
            var o = Object.assign({}, t._themes);
            if ("default" !== r) {
                var n = e.themes[r];
            ...
            if (t.updateStyles ? t.updateStyles(o) : window.ShadyCSS && window.ShadyCSS.styleSubtree(t, o), s) {
                ...
                if (a) {
                    ...
                    var c = o["--primary-color"] || a.getAttribute("default-content");
                    a.setAttribute("content", c)
                }
            }
        }(this, this.hass.themes, this.config.theme)), this.ctrl.log("Updated", this.ctrl.value)
    }
    firstUpdated(t) {
    ...
    render() {
        var t, e, i, s, r;
        return this.ctrl.hass = this.hass, this.ctrl.stateObj ? Rt`
      <ha-card
        tabindex="0"
    ...
    ` : this._showError(ps("common.show_error"))
    }
    renderText() {
        return this.config.show_name || this.config.show_state ? Rt`
          <div class="text">
    ...
    renderIcon() {
        var t;
        if (!1 === (null === (t = this.config.icon) || void 0 === t ? void 0 : t.show)) return Rt``;
        let e = !1,
            i = "";
        return this.ctrl.stateObj.attributes.entity_picture && (i = `url(${this.ctrl.stateObj.attributes.entity_picture})`, e = !0), Rt`
    ...
    renderAction() {
        var t, e, i, s, r;
        return !1 === (null === (t = this.config.action_button) || void 0 === t ? void 0 : t.show) ? Rt`` : (null === (e = this.config.action_button) || void 0 === e ? void 0 : e.mode) === me.TOGGLE ? Rt`
        <div class="action">
          <ha-switch
    ...
    _handleAction(t, e) {
        var i;
        this.hass && this.config && t.detail.action && ("toggle" !== (null === (i = e.tap_action) || void 0 === i ? void 0 : i.action) || this.ctrl.isUnavailable || this.animateActionStart(), E(this, this.hass, Object.assign(Object.assign({}, e), {
            entity: this.config.entity
        }), t.detail.action))
    }
    async handleClick(t) {
        this.ctrl.hasToggle && !this.ctrl.isUnavailable && (t.preventDefault(), this.animateActionStart(), this.ctrl.log("Toggle"), await P(this.hass, this.config.entity))
    }
    _toggle() {
        this.hass && this.config && E(this, this.hass, {
            tap_action: {
                action: "toggle"
            },
            entity: this.config.entity
    ...
    getColorFromVariable(t) {
        if (void 0 !== t && "var" === t.substring(0, 3)) {
            let e = window.getComputedStyle(this).getPropertyValue(t.substring(4).slice(0, -1)).trim();
            return e.length || (e = window.getComputedStyle(document.documentElement).getPropertyValue(t.substring(4).slice(0, -1)).trim()), e
        }
        return t
    }
    onPointerDown(t) {
        t.preventDefault(), t.stopPropagation(), this.ctrl.isSliderDisabled || this.slider.setPointerCapture(t.pointerId)
    }
    onPointerUp(t) {
        this.ctrl.isSliderDisabled || (this.setStateValue(this.ctrl.targetValue), this.slider.releasePointerCapture(t.pointerId))
    }
    onPointerMove(t) {
        if (this.ctrl.isSliderDisabled) return;
        if (!this.slider.hasPointerCapture(t.pointerId)) return;
        const {
            left: e,
            top: i,
            width: s,
            height: r
        } = this.slider.getBoundingClientRect(), o = this.ctrl.moveSlider(t, {
            left: e,
            top: i,
            width: s,
            height: r
        });
        this.ctrl.log("onPointerMove", o), this.updateValue(o)
    }
    connectedCallback() {
